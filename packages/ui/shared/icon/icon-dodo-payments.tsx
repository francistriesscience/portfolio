...
export function IconDodoPayments({
  className,
  render,
  ...props
    ...
    props: mergeProps<"svg">(defaultProps, {
      ...
      children: (
        <>
          ...
          <mask id="icon-dodo-payments-mask-a" x="18" y="27" width="91" height="76" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }}>
            <path fill="#fff" d="M108.5 27.5h-90v75h90z" />
          </mask>
          <g fill="#0d0d0d" mask="url(#icon-dodo-payments-mask-a)">

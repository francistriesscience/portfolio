      ...
      children: (
        <>
          ...
          <g mask="url(#icon-vscode-mask)">
            ...
            />
            <g filter="url(#icon-vscode-filter-b)">
              <path
                fill="#007ACC"
            ...
            <g filter="url(#icon-vscode-filter-c)">
              <path
                fill="#1F9CF0"
            ...
            <path
              fill="url(#icon-vscode-gradient-d)"
              fillRule="evenodd"

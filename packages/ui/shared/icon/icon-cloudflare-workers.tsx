...
export function IconCloudflareWorkers({
  className,
  render,
  ...props
  ...
  const defaultProps = {
    ...
    "data-slot": "icon-cloudflare-workers",
    fill: "none",
  ...
  return useRender({
    ...
    props: mergeProps<"svg">(defaultProps, {
      ...
      children: (
        <>
          <defs>
            <linearGradient id="icon-cloudflare-workers-a" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
              <stop offset="0%" stopColor="#EB6F07" />
              <stop offset="100%" stopColor="#FAB743" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-b" x1="81%" x2="40.5%" y1="83.7%" y2="29.5%">
              <stop offset="0%" stopColor="#D96504" />
              <stop offset="100%" stopColor="#D96504" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-c" x1="42%" x2="84%" y1="8.7%" y2="79.9%">
              <stop offset="0%" stopColor="#EB6F07" />
              <stop offset="100%" stopColor="#EB720A" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-d" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
              <stop offset="0%" stopColor="#EE6F05" />
              <stop offset="100%" stopColor="#FAB743" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-e" x1="-33.2%" x2="91.7%" y1="100%" y2="0%">
              <stop offset="0%" stopColor="#D96504" stopOpacity=".8" />
              <stop offset="49.8%" stopColor="#D96504" stopOpacity=".2" />
              <stop offset="100%" stopColor="#D96504" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-f" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
              <stop offset="0%" stopColor="#FFA95F" />
              <stop offset="100%" stopColor="#FFEBC8" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-g" x1="8.1%" x2="96.5%" y1="1.1%" y2="48.8%">
              <stop offset="0%" stopColor="#FFF" stopOpacity=".5" />
              <stop offset="100%" stopColor="#FFF" stopOpacity=".1" />
            </linearGradient>
            <linearGradient id="icon-cloudflare-workers-h" x1="-13.7%" x2="100%" y1="104.2%" y2="46.2%">
              <stop offset="0%" stopColor="#FFF" stopOpacity=".5" />
              <stop offset="100%" stopColor="#FFF" stopOpacity=".1" />
            </linearGradient>
          </defs>
          <path
            fill="url(#icon-cloudflare-workers-a)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-b)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-c)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-d)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-e)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-f)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-g)"
          ...
          />
          <path
            fill="url(#icon-cloudflare-workers-h)"
